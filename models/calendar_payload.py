...
# class EventSchema:
#     """
#     캘린더 이벤트/태스크를 위한 내부 데이터베이스 스키마입니다.
#     """
#     # 필수 필드
#     id: uuid.UUID = field(default_factory=uuid.uuid4)
#     user_id: Optional[uuid.UUID] = None  # 에이전트가 실행되는 시점에서는 user_id를 모를 수 있어 Optional로 설정
#     title: str = ""
...
#     timezone: str = "Asia/Seoul"
#     status: Optional[str] = None  # 예: "completed", "pending"
#     recurrence_rule: Optional[str] = None

#     # 메타 정보
#     source_type: str = "manual"  # 예: "manual", "parsed"
#     created_by_agent: str = "manual"
#     used_agents: List[Dict[str, Any]] = field(default_factory=list)
...
# def get_event_schema_template() -> Dict[str, Any]:
#     """
#     빈 EventSchema 딕셔너리 템플릿을 반환합니다.
#     이 함수는 에이전트가 초기 구조를 잡을 때 사용할 수 있습니다.
#     """
#     return {
#         "id": None,
#         "user_id": None,
